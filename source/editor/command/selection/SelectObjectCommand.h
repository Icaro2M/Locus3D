...
namespace locus::editor {
	...
	/**
	 * @brief Command that selects one scene object.
	 */
	class SelectObjectCommand final : public ICommand {
	public:
		/**
		 * @brief Creates a command.
		 *
		 * @param id Object to select.
		 */
		explicit SelectObjectCommand(SceneNodeId id);
