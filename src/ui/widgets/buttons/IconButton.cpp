...
namespace ui
{
    static ImVec4 ResolveBackgroundColor(const IconButtonConfig& config, bool hovered)
    {
    ...
    static ImVec4 ResolveBorderColor(const IconButtonConfig& config)
    {
        const ButtonVisualStyle& style = config.style;
    ...
    static ImVec4 ResolveIconColor(const IconButtonConfig& config)
    {
        const ButtonVisualStyle& style = config.style;
    ...
    bool IconButton(const IconButtonConfig& config)
    {
        ...
        if (config.enabled)
        {
            pressed = ImGui::InvisibleButton("##icon_button", size);
        }
        else
        {
            ImGui::BeginDisabled();
