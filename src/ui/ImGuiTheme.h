...
inline void ApplyModernTheme()
{
    ...
    // Espaçamentos mais confortáveis (padding)
    ...
    // Cabeçalhos (Selectables, CollapsingHeaders)
    colors[ImGuiCol_Header]                 = ImVec4(0.22f, 0.28f, 0.40f, 1.00f); // Azul escuro selecionado
