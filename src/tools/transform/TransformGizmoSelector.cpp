#include "TransformGizmoSelector.h"
...
bool TransformGizmoSelector::rayIntersectsAABB(
    const Ray& ray,
    const glm::vec3& min,
    const glm::vec3& max,
    float& tOut
...
void TransformGizmoSelector::buildAxisAABB(
...
TransformAxis TransformGizmoSelector::selectAxis(
